...
unique(engag_score$covid_19_whats_app_chatbot_content_visual_information_language_design)

engag_score_2 <- engag_score %>% 
  mutate(
...
Mars_data1[is.na(Mars_data1[c(2:26,1)])]<-0

...
differences <- df_paired$gen_score - df_paired$moh_score
shapiro_test <- shapiro.test(differences)
...
# will run the paired t.test on the scores 

t.test_result<-t.test(df_paired$moh_score, df_paired$gen_score, 
                      paired = T)

...
# calculation the difference on TAM scores among the Moh and general public. 
...
# sub setting post survey
moh_survey<- tama2 %>%
    filter(is_it_pre_or_post_survey=="MoH") %>% 
    select(7:11)

# sub setting pre survey
gen_public_survey <- tama2 %>%
    filter(is_it_pre_or_post_survey=="General Public") %>% 
    select(7:11)

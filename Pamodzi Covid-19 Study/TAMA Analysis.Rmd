...
tama_data<-read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vTZVNeFbJTiW99FNEBGK9knyXFb7oWJj4gdu_aWB4lvWa1wqIabuvtFD27wh4W7Bg/pub?gid=389095188&single=true&output=csv")

#cleaning the variable names of the data set
tama_data<-clean_names(tama_data)
...
table(tama_data$is_it_pre_or_post_survey)
tama_data %>% 
...
tapply(
  tama_data$number_of_years_of_experience_in_covid_19_response
)

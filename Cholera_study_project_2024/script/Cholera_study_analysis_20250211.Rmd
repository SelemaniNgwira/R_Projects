...
table3.1.0 <-  create_summary_table3(table3.1.0,grouping_vars,"vaccined_with_ocv") |> 
                    as_flextable() |>
                    autofit() |>
                    set_table_properties(layout = "autofit")
...
table3.1.1 <-  create_summary_table3(table3.1.1,grouping_vars,"vaccined_with_ocv") |> 
as_flextable() |>
autofit() |>
set_table_properties(layout = "autofit")
...
table3.2.0 <-  create_summary_table3(table3.2.0,grouping_vars,"ocv_prevent_cholera") |> 
                    as_flextable() |>
                    autofit() |>
                    set_table_properties(layout = "autofit")
...
table3.2.1 <-  create_summary_table3(table3.2.1,grouping_vars,"ocv_prevent_cholera") |> 
                    as_flextable() |>
                    autofit() |>
                    set_table_properties(layout = "autofit")
...
table3.4.0 <-  create_summary_table3(table3.4.0,grouping_vars,"safe_vaccine") 
...
table3.4.1 <-  create_summary_table3(table3.4.1,grouping_vars,"safe_vaccine") 
...
save_as_docx(table3.4.1, path = here("output/table3_4_1.docx"))
...
table3.6.0 <-  create_summary_table3(table3.6.0,grouping_vars,"ocv_access") 

table3.6.0

table3.6.0 <- table3.6.0 |> 
          as_flextable() |>
          autofit() |>
          set_table_properties(layout = "autofit")
...
table3.6.1 <- cholera_data |> 
            select(ocv_access,district,residence)
...
table3.6.1 <-  create_summary_table3(table3.6.1,grouping_vars,"ocv_access") 
...
table3.7.0 <-  create_summary_table3(table3.7.0,grouping_vars,"received_ocv") 
...
table3.7.1 <-  create_summary_table3(table3.7.1,grouping_vars,"received_ocv") 
...
table3.8.0 <-  create_summary_table3(table3.8.0,grouping_vars,"family_members_vaccinated") 
...
table3.9.1 <-  create_summary_table3(table3.9.1,grouping_vars,"will_to_get_vaccinated") 

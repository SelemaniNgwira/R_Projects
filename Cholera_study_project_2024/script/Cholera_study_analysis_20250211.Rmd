...
# importing the data 
cholera_data<-import(here("Cholera_study_project_2024/data/cholera_data_.csv")) %>%
                clean_names() %>% 
...
table3.9.1 <- cholera_data |> 
            select(district,zone,will_to_get_vaccinated,residence) %>% 
...
create_summary_table(available_toilet_demo, "sex", 
                     "toilet_facility_avaiable")
create_summary_table(available_toilet_demo, "level_education",
                     "toilet_facility_avaiable")
create_summary_table(available_toilet_demo, "ethnicity",
                     "toilet_facility_avaiable", 
                      adorn_totals = T)
...
## 5.	Do they have hand wash facility at the pit latrine?
...
## 6.	How often do you and your family use these sanitation facilities?
...
## 8.	Is there any shared usage of toilets/latrines with other households
